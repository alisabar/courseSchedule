...
import com.alisa.mn.Guis.TeachingGui;
...
public class MainGui extends JPanel {
	...
	public MainGui() {
		...
		_dynamicPanel.add(new JLabel("COURSE SCHEDULE"));
	...
	protected JPanel CreateButtonsShowTablePanel() {
		...
		JButton buttonLecturersAndCourses = new JButton("Teaching");
